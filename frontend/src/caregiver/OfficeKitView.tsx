...
export default function OfficeKitView() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 font-sans transition-colors duration-150">
      {/* Top Navbar */}
      <nav className="bg-slate-950/80 backdrop-blur-md border-b border-slate-800 px-6 py-3.5 flex justify-between items-center sticky top-0 z-30">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-base sm:text-lg font-black tracking-tight text-white">MINDMITRA OFFICE KIT</h1>
                <span className="px-2 py-0.5 rounded-md bg-indigo-950 border border-indigo-500/50 text-[10px] font-bold text-indigo-300">
                  Caregiver Intelligence Layer
                </span>
              </div>
              <p className="text-[11px] text-slate-400 font-bold">Real-Time Phone Telemetry Aggregator & Longitudinal Explainer</p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-6 flex flex-col gap-6">
        ...
        <div className="p-3.5 rounded-2xl bg-slate-950 border border-slate-800 flex flex-wrap items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-extrabold text-white">Office Kit Bridge: Active</span>
            <span className="text-slate-400">• Receiving synced summaries from iQOO Phone</span>
          </div>

          <div className="flex items-center gap-2">
            <span className="text-[11px] text-slate-400">Model: {latestPacket?.onDeviceML.model || 'MindMitra-RF-Mobile'}</span>
            <span className="px-2 py-0.5 rounded bg-emerald-950/80 border border-emerald-500/40 text-[10px] font-bold text-emerald-400">
        ...
        {latestPacket ? (
          <div className="p-6 sm:p-8 rounded-3xl bg-slate-950 border border-slate-800 shadow-xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 my-6">
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 text-left">
                <span className="text-xs text-slate-400 font-bold block mb-1">Accuracy</span>
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 text-left">
                <span className="text-xs text-slate-400 font-bold block mb-1">Response Time</span>
                <div className="flex items-baseline gap-2">
                  <span className="text-xl font-extrabold text-slate-400">
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 text-left">
                <span className="text-xs text-slate-400 font-bold block mb-1">Corrections & Retries</span>
                <div className="flex items-baseline gap-2">
                  <span className="text-xl font-extrabold text-slate-400">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 text-left">
                <span className="text-[11px] font-black uppercase text-indigo-400 tracking-wider block mb-2">
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 text-left">
                <span className="text-[11px] font-black uppercase text-blue-400 tracking-wider block mb-2">
            ...
            <div className="pt-4 border-t border-slate-800 flex flex-col gap-4">
              ...
              {showExplanation && (
                <div className="p-5 rounded-2xl bg-indigo-950/40 border border-indigo-500/40 animate-in fade-in text-left">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-[10px] text-slate-400">Empathetic Non-Diagnostic Summary</span>
                  </div>
                  ...
                  <div className="mt-3 pt-3 border-t border-indigo-900/60 flex items-center gap-2 text-[11px] text-amber-300/90 font-bold">
          ...
          <div className="card p-12 text-center text-slate-400">
            ...
            <h3 className="font-bold text-white">Listening for Phone Telemetry...</h3>
          ...
          <div className="p-6 rounded-3xl bg-slate-950 border border-slate-800">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs text-slate-300">
                <thead className="text-[10px] text-slate-500 uppercase border-b border-slate-800 font-extrabold">
                  <tr>
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {historyPackets.map((pkt) => (
                    <tr key={pkt.id} className="hover:bg-slate-900/50 transition-colors">
                      <td className="py-2.5 px-3 text-slate-400">{new Date(pkt.timestamp).toLocaleTimeString()}</td>
                      <td className="py-2.5 px-3 font-extrabold text-white">{pkt.profileName}</td>
                      ...
                      <td className="py-2.5 px-3 text-slate-400">{pkt.onDeviceML.latencyMs}ms</td>
                    </tr>
                  ))}
                </tbody>
              </table>
